...
public class TikCommandTrapException : TikCommandException
{
    ...
    /// <param name="trapSentence">
    ///     Error=trap sentence returned from mikrotik router as response to <paramref name="command" />
    ///     call.
    /// </param>
...
/// <summary>
///     Exception thrown when item with identifier alraedy exists. (e.q. 'already have device with such name' or 'failure:
///     already have such address' message from API)
/// </summary>
/// <remarks>
///     ctor.
/// </remarks>
...
public class TikAlreadyHaveSuchItemException(ITikCommand command, ITikTrapSentence trapSentence)
    : TikCommandTrapException(command,
        trapSentence)
{
}
